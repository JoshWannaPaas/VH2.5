...
onEvent('jei.hide.items', event => {
	...
	event.hide('sophisticatedbackpacks:advanced_smelting_upgrade')
	event.hide('sophisticatedbackpacks:smoking_upgrade')
	event.hide('sophisticatedbackpacks:advanced_smoking_upgrade')
	event.hide('sophisticatedbackpacks:blasting_upgrade')
	event.hide('sophisticatedbackpacks:advanced_blasting_upgrade')
