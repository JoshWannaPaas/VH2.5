...
onEvent('recipes', event => {
    ...
    event.remove({output: 'botania:pixie_dust'})
    event.remove({output: 'botania:elementium_ingot'})
    event.remove({output: 'botania:elementium_block'})
    event.remove({output: 'botania:dragonstone'})
    event.remove({output: 'botania:dragonstone_block'})
    event.remove({output: 'botania:dreamwood'})
